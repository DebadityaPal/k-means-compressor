...
def calculate_compressed_image(file_name,n_clusters = 64):
    ...
    compressed_img_array,centroids = obj.k_means_clustering(64,standardized_array)
    obj.show_img(compressed_img_array,centroids,img_array)



# calculate_compressed_image('beautiful_scenery.jpeg')
# flip_images_horizontly_and_vertically('beautiful_scenery.jpeg')
RGB_to_gray.RGB_to_gray.convert_to_gray_scale('beautiful_scenery.jpeg')